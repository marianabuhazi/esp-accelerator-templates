...
template <size_t _DMA_WIDTH_> inline void esp_accelerator_2P<_DMA_WIDTH_>::reset_load_input()
{
    input_ready.req.reset_req();
    this->reset_dma_read();
}

template <size_t _DMA_WIDTH_> inline void esp_accelerator_2P<_DMA_WIDTH_>::reset_compute_store()
{
